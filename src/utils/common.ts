...
export class CommonUtils {
  ...
  static fillPaginationParams(
    ...
    baseQuery.page_index = pagination.currentPage;
    baseQuery.page_size = pagination.pageSize;
  }
  ...
  static fillSortParams(baseQuery: BasePageQuery, sort: Sort) {
    ...
    baseQuery.order_column = sort.prop;
    baseQuery.order_direction = sort.order;
  }
  ...
  static fillTimeRangeParams(baseQuery: any, timeRange: string[]) {
    if (timeRange == null || timeRange.length == 0 || timeRange === undefined) {
      baseQuery["begin_time"] = undefined;
      baseQuery["end_time"] = undefined;
      return;
    }
    ...
    baseQuery["begin_time"] = CommonUtils.getBeginTimeSafely(timeRange);
    baseQuery["end_time"] = CommonUtils.getEndTimeSafely(timeRange);
  }
