...
export const isRememberMeKey = "slurry-is-remember-me";
export const passwordKey = "slurry-password";
...
export function getToken(): TokenDTO {
  ...
  return Cookies.get(tokenKey)
    ...
    : storageLocal().getItem<TokenDTO>(userKey)?.token;
}
...
export function setToken(data: TokenDTO): void {
